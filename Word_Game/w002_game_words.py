...
"""найти сайт с описание слов и от туда парсить описание задуманного слова"""

"""Ниже выбираем версию игры."""
def ver():
    print("Введите 1, если хотите легкий режим(2 подсказки).В виде открытых 2 случайных букв.")
    print("Введите любой символ, если хотите сложный режим.В сложной версии подсказок нет!")
...
while input("Нажми пробел, что бы сыграть") == " ":
